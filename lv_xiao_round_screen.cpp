...
void lv_xiao_disp_init(void)
{
	...
	// Updated to use double buffering
    static lv_disp_draw_buf_t draw_buf;
	static LV_ATTRIBUTE_DMA LV_ATTRIBUTE_MEM_ALIGN lv_color_t buf1[SCREEN_WIDTH * LVGL_BUFF_SIZE * LV_COLOR_DEPTH / 8];
	//static lv_color_t* buf1 = (lv_color_t*)heap_caps_aligned_alloc(32, (SCREEN_WIDTH * LVGL_BUFF_SIZE * LV_COLOR_DEPTH / 8, MALLOC_CAP_DMA);
	static LV_ATTRIBUTE_DMA LV_ATTRIBUTE_MEM_ALIGN lv_color_t buf2[SCREEN_WIDTH * LVGL_BUFF_SIZE * LV_COLOR_DEPTH / 8];
	//static lv_color_t* buf2 = (lv_color_t*)heap_caps_aligned_alloc(32, (SCREEN_WIDTH * LVGL_BUFF_SIZE * LV_COLOR_DEPTH / 8, MALLOC_CAP_DMA);
    lv_disp_draw_buf_init(&draw_buf, buf1, buf2, SCREEN_WIDTH * LVGL_BUFF_SIZE);
